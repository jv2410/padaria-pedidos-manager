...
-- Criar políticas básicas para as tabelas que existem
-- Chart of Accounts
...
-- Subscribers - política mais permissiva para o sistema funcionar
CREATE POLICY "Allow all operations on subscribers"
ON public.subscribers
USING (true)
WITH CHECK (true);

-- Corrigir funções adicionando search_path
